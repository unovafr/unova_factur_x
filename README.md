...
- with_validations: true ou false, si à true, va essayer de valider le XML généré avant de l'attacher à la facture /!\ Nécessite Java, à désactiver si Java non présent /!\ (true par défaut)
```ruby
